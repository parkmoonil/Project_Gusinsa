...
public class Review_Written_Dto {
	...
	public Review_Written_Dto(int r_num, int p_code, int r_starpoint, String r_title, String r_contents, String r_img,
			String p_name, int r_likepoint, String mid, Timestamp r_date, int r_hit, int o_code) {
		super();
		this.r_num = r_num;
		this.p_code = p_code;
