...
#product_menu_list{font-size: 25px;display: inline-block; left: 16.5%;  z-index: 1;} /* 메뉴 카테고리 좌우 이동*/
...
.BRAND_Three li{ width: 300px; height: 40px; padding-bottom: 7px; }  /*중분류 리스트 사이즈*/
...
.ViewallBrands_Three li{ width: 300px; height: 40px; padding-bottom: 7px; }  /*중분류 리스트 사이즈*/
