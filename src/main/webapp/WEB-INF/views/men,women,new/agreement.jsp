...
<body>
 <style>
    ...
    <h1 style="background-color: rgb(20, 20, 34); color: white;">전자금융거래 이용약관</h1>
    <div class="box1">
    <p>
       <h3>제1조 (목적)</h3> 
        이 약관은 주식회사 구신사(이하 '회사'라 합니다)가 제공하는 전자지급결제대행서비스 및 결제대금예치서비스를 이용자가 이용함에 있어 회사와 이용자 사이의 전자금융거래에 관한 기본적인 사항을 정함을 목적으로 합니다.
       <h3>제2조 (용어의 정의)</h3>    
       ...
       <h3> 제8조 (거래내용의 확인)</h3> 
        ...
        주소: (04517) 서울특별시 구로구 구트타워
        이메일 주소: tbasic@goott.com
        전화번호: 1588-4954
        <h3>제9조 (오류의 정정 등) </h3> 
        ...
        <h3>제13조 (전자지급결제대행 서비스 이용 기록의 생성 및 보존) </h3> 
