...
<body>
	...
	<div id="__next" data-reactroot="">
		...
		<section style="background-image: url(resources/brandimg/homegrown_svpply/homegrown_svpply.jpeg)" class="css-background-img">

			<div class="css-brand-text-1">

				<div class="css-brand-text-2">

					<h3 class="css-brand-text-3">HOMEGROWN SVPPLY&CO</h3>

					<strong class="css-brand-text-4">홈그라운드 서플라이</strong>

					<div class="css-brand-text-5">

						<div class="css-brand-text-6">

							<div class="css-brand-text-7">CHAPTER VI - 'NEVER GREEN STORE'는 'ANTEOK' 
								모든 챕터들을 담을 수 있는 공간의 개념이다. '네버그린스토어'의 프라이빗 브랜드로 탄생한 
								'HOMEGROWN SVPPLY'는 그동안 소통해왔던 고객들께 보답하는 의미의 브랜드입니다.</div>

						</div>

						<div class="css-brand-text-8">CHAPTER VI - 'NEVER GREEN STORE'는 'ANTEOK' 
								모든 챕터들을 담을 수 있는 공간의 개념이다. '네버그린스토어'의 프라이빗 브랜드로 탄생한 
								'HOMEGROWN SVPPLY'는 그동안 소통해왔던 고객들께 보답하는 의미의 브랜드입니다.</div>
