    ...
    <div class="wrapper">
	    ...
	    <div class="container sign-in agreement">
	        ...
	        <div class="btn-bottom-area type01">
			 	<button type="button" class="white btn-prev" onclick="location.href='joinform2'">이전</button>
	            <button type="button" class="basic btn-next" onclick="location.href='joinform4'">다음</button>
	        </div>
