...
<link rel="stylesheet" href="resources/css/reviewboard_view.css" />
</head>
...
<div class="detail">
<h3>유저리뷰</h3>
<input type="hidden" name="r_num" value="${reviewboard_view.r_num }" />
		<div>
			<span class="left1">아이디<span>
			</span>${reviewboard_view.mid }</span>
			<span class="left2">조회수
			${reviewboard_view.r_hit }</span>
		</div>
		<div>
			<span class="left3">
		...
		<div>
			...
			<span><fmt:formatDate value="${reviewboard_view.r_date}" pattern = "yyyy.MM.dd"/></span>
		</div>
		<div>
			<span class="left">상품</span>
			<span><a href="reviewboard_view?BuyPage=${reviewboard_view.p_code }">${reviewboard_view.p_code }</span>
		</div>
